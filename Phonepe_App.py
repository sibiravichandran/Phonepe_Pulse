            ...
            if menu=="User":
                ...
                if select_option == 'Aggregated':
                    ...
                    #st.dataframe(df_agg)
                        ...
                        fig2 = px.bar(data, x='Brands', y='Count',
                                hover_data=['Reg_Users','App_Opens','Count'], color='Count',
                                height=400,color_continuous_scale='oxy')
                        st.plotly_chart(fig2,theme="streamlit",use_container_width=True)
                ...
                if select_option == 'Map':
                    ...
                    fig2 = px.bar(data, x='District', y='Reg_Users',
                            ...
                            height=400,color_continuous_scale='piyg')
                    st.plotly_chart(fig2,theme="streamlit",use_container_width=True)
                ...
                if select_option == 'Top':
                    ...
                    fig2 = px.bar(data, x='District', y='Reg_Users',
                            ...
                            labels={'Reg_Users':'Reg_Users'}, height=400,color_continuous_scale='delta')
                    st.plotly_chart(fig2,theme="streamlit",use_container_width=True)
...
def Fun_Facts():
    ...
    if selected_fact == "Top 10 states based on amount of transaction":
        ...
        fig = px.bar(df, x="State", y="Transaction_amount", color="State", color_continuous_scale="rainbow")
