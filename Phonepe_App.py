...
#with st.sidebar:
    ...
    options = ["About","Home","Overview of Insights","Analyze Insights","Discoveries","Contact"],
    icons =["bar-chart","house","toggles","search","list-task", 'at'],
...
def Insights():
    ...
    if selected3 == 'Transaction Data Insights':
        ...
        if select == 'Aggregated':
            ...
            #df_agg = pd.read_sql(f"SELECT * FROM statewise_agg_users WHERE Payments = '{payment}' AND Year BETWEEN 2018 AND 2022 AND Quarter = {quarter}", con=my_connection)
        ...
        if select == 'User':
            ...
            insight_map_fig = px.line(insight_map, x="Year", y="Total_Metric",color='District' ,title='Analysis Based on the type of Payment and Metric between 2018 - 2022 for each Quarter', 
                                      markers=True,
                                  width=800, height=600)
        ...
        if select == 'Top':
            ...
            if select1 == 'District':
                ...
                insight_top_fig = px.line(insight_top, x="Year", y="Total_Metric",color='District' ,title='Analysis Based on the type of Payment and Metric between 2018 - 2022 for each Quarter', 
                                        markers=True,
                                    width=800, height=600)
    ...
    if selected3 == 'User Data Insights': 
        ...
        if select == 'Aggregated':
            ...
            user_insight_fig = px.line(user_insight_data, x="Year", y="Total_Metric",color='State' ,title='Analysis Based on the type of Payment and Metric between 2018 - 2022 for each Quarter', markers=True,
        ...
        if select == 'User':
            ...
            insight_map_user_fig = px.line(insight_map_user, x="Year", y="Total_Metric",color='District' ,title='Analysis Based on the type of Payment and Metric between 2018 - 2022 for each Quarter', 
                                      markers=True,
                                  width=800, height=600)
        ...
        if select == 'Top':
            ...
            if select2 == 'District':
                ...
                insight_top_fig = px.line(insight_top_user, x="Year", y="Total_Reg_Users",color='District' ,title='Analysis Based on the type of Payment and Metric between 2018 - 2022 for each Quarter', 
                                        markers=True,
                                    width=800, height=600)
                st.plotly_chart(insight_top_fig)
