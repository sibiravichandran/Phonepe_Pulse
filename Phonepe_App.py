...
def MetricDefinitions():
    ...
    st.header(":orange[Digital payments]")
    ...
    st.header(":green[Offline merchants]")
    ...
    st.header(":orange[Offline transactions]")
    ...
    st.header(":green[Online merchants]")
    ...
    st.header(":orange[Online transactions]")
    ...
    st.header(":green[Registered Users]")
    ...
    st.header(":orange[Value of gold purchased]")
